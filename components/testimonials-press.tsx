...
export function TestimonialsAndPress() {
  ...
  const brandedQuote = (active.quote || "").replaceAll("Maison", companyName || "Maison")
          ...
          <ScrollReveal>
            <div className="mb-16 flex flex-col items-center text-center">
              <div className="mb-6 inline-flex items-center gap-3">
                ...
                <span className="text-xs font-sans tracking-[0.4em] text-gold uppercase">
                  Client Voices
                </span>
                <span className="h-px w-8 bg-gold" />
              </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <blockquote className="text-center">
                  <p className="font-sans text-xl font-light leading-relaxed tracking-wide text-foreground sm:text-2xl lg:text-[1.65rem] lg:leading-relaxed">
                    &ldquo;{brandedQuote}&rdquo;
                  </p>
                </blockquote>
                ...
                <div className="mt-6 flex flex-col items-center gap-1">
                  ...
                  <div className="mt-2 flex items-center gap-3 font-sans text-[11px] text-muted-foreground/60">
      ...
      <ScrollReveal>
        <div id="press" className="border-t border-border bg-secondary py-16 lg:py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            {/* Featured In */}
            <div className="mb-12">
              <p className="mb-8 text-center font-sans text-[11px] tracking-[0.3em] text-muted-foreground/60 uppercase">
                As Featured In
              </p>
              <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-16">
                {pressLogos.map((logo) => (
                  <span
                    key={logo.name}
                    className="font-sans text-lg font-medium tracking-[0.15em] text-muted-foreground/30 transition-colors duration-300 hover:text-muted-foreground/60 sm:text-xl"
                  >
                    {logo.abbr}
                  </span>
                ))}
            ...
            <div className="border-t border-border pt-12">
              ...
              <div className="grid grid-cols-2 gap-px bg-border lg:grid-cols-4">
                {awards.map((award) => (
                  ...
                  >
                    <span className="block font-sans text-[11px] tracking-[0.2em] text-gold uppercase">
                      {award.year}
                    </span>
                    <span className="mt-2 block font-serif text-base font-medium tracking-tight text-foreground">
                      {award.title}
                    </span>
